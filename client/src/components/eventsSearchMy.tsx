...
export const EventsSearchMy = ({
  ...
  const handleSearch = () => {
    ...
    axios
      .get(
        `http://localhost:3000/api/events/myEvents?search=${search}&venue=${venue}&city=${city}&country=${country}&startDate=${startDate}&endDate=${endDate}`,
        {
